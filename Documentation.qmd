...
Comparison of the identified clusters against ground truth labels are depicted in @fig-kmeans-02. The accuracy and quality of the clustering were assessed as included in @tbl-kmeans. Besides, it's worth mentioning that even this simple dataset with 4 features required 6 individual pairwise plots to observe the patterns from every angle.

| Homogeneity | Completeness | V-measure | Accuracy |
|------------:|-------------:|----------:|---------:|
|       0.798 |        0.773 |     0.786 |    0.915 |

: Performance evaluation of the *K-means* clustering. {#tbl-kmeans}
