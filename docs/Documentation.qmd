...
![K-means behavior illustrated on simple synthetic datasets with different shapes.](_images/kmeans_behavior_01.png)

![K-means behavior illustrated on simple synthetic datasets with different shapes.](_images/kmeans_behavior_02.png)
...
![A diagram of a feedforward artificial neural network illustrating the flow of data through input, hidden, and output layers.](./_images/ann.png){#fig-ann width=80%}
...
\newpage
### Experiment 2: Representation learning via Self-Organizing Map (SOM)
...
\newpage
### Experiment 3: SOM representation based clustering
